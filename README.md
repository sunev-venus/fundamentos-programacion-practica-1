...
### Lo que más me costó
- **Sección 5 (Arrays Bidimensionales - Matrices)**: Es un tema que todavía no había visto y tuve que investigar bastante para poderlos hacerlos.
- **Sección 4 (Arrays)**: Este igual era un tema nuevo pero en este caso ya lo habíamos empezado a ver en programación pero aún no lo había entendido muy bien y me costó más tiempo que otros

### Lo que más me gustó
- **Hacer los ejercicios**: Sentí que esta actividad fue un muy bien repaso sobre los temas vistos y su implementación en ejemplos, como dos materías se pueden complementar y de igual forma me resultó muy entretenido hacerlo.
- **Guardar cambios**: Era algo nuevo para mi, sé que se puede hacer todo desde terminal pero no sé mucho sobre su implementación y usarlo en esta práctica me mostró que facilita las cosa para mejorar su eficiencia.
...
**Por qué me gusta:** Demuestra hacer una matriz implementando ciclos anidados.
...
- **Profesor Jorge Javier Pedrozo Romero** por la estructura del curso, la práctica y por ayudarme a encontrar donde se guardaban mis commit.
- **Compañeros del Grupo [B/C]** por ayudarme a resolver mis dudas y checar si estaban bien los ejercicios.
- **Tecnológico de Software** por darme la oporunidad de desarrollarme de manera profesional y didacticta desde un principio.

---

## 📧 Contacto

- **Email Institucional:** venus.semino@tecdesoftware.edu.mx
- **GitHub:** sunev-venus (https://github.com/sunev-venus)
...
Hecho con 💙 por Venus Semino - 2025
